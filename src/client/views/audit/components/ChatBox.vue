    ...
    <div class="chat-items">
      ...
      >
        <div class="chat-question-left">
          ...
          <ResponseProgress hidden="p" title="问题解读" class="progress" :chatdata="item" />
          <div>
...
const chatData = computed(() => store.state.chat.auditData);
const pdfData = computed(() => {
  const showDrawer = store.state.chat.showDrawer;
  const chatInputWidth = "calc(100% - 300px)";
